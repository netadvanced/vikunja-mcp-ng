...
- [OIDC setup manual](docs/OIDC-SETUP.md) — installing and configuring hosted, multi-user mode: every config key, identity-provider setup, a layer-by-layer verification ladder, and operations
- [IBM MCP Context Forge deployment guide](docs/CONTEXT-FORGE.md) — the Context-Forge-specific layer on top of the OIDC setup manual
